...
## 安装containerd,nfs-utils,kubectl,kubeadm,kubelet
...
执行安装脚本：`bash install.sh -s 1.22.31`
...
DEVICE=ens33
ONBOOT=yes #系统启动时开启
IPADDR=192.168.205.135 # 静态ip地址
NETMASK=255.255.255.0 # 子网掩码
GATEWAY=192.168.205.2 # 第3步中查看的网关ip
PREFIX=24
...
```
192.168.205.135 master
192.168.205.136 worker1
```
...
执行脚本：`sh init.sh -s 1.22.1 /coredns`
...
配置文件：`calico-custom-resources.yaml`
...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
        - name: tigera-operator
          # image: quay.io/tigera/operator:v1.23.1
          image: swr.cn-east-2.myhuaweicloud.com/kuboard-dependency/tigera-operator:v1.23.1
...
export MASTER_IP=192.168.205.135
...
master    Ready    control-plane,master   57m   v1.21.5   192.168.205.135   <none>        CentOS Stream 8   4.18.0-338.el8.x86_64   containerd://1.4.3
worker1   Ready    <none>                 53m   v1.21.5   192.168.205.136   <none>        CentOS Stream 8   4.18.0-338.el8.x86_64   containerd://1.4.3
