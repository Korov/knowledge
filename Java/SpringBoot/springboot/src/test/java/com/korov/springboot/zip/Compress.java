package com.korov.springboot.zip;
...
public class Compress {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String targetFolderPath = "src\\test\\resources\\test\\zip";
        String rawZipFilePath = "src\\test\\resources\\test\\zip\\data.zip";
        String newZipFilePath = "src\\test\\resources\\test\\zip\\new.zip";
