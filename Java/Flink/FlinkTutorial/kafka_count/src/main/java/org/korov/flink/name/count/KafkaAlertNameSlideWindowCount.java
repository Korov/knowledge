 ...
 * org.korov.flink.name.count.KafkaAlertNameSlideWindowCount
 * <p>
 * --mongo_host 192.168.50.100 --mongo_port 27017 --mongo_db kafka --mongo_collection kafka_alert_name_slide_count --kafka_addr 192.168.1.19:9092 --kafka_topic flink_siem --kafka_group kafka-alert-name-slide-count
 *
 * @author zhu.lei
 * @date 2021-05-05 14:00
 */
@Slf4j
public class KafkaAlertNameSlideWindowCount {
    ...
    public static void main(String[] args) throws Exception {
        ...
        env.execute("KafkaAlertNameSlideWindowCount");
    }
}
