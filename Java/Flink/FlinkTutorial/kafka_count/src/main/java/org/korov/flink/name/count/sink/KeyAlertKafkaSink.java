...
public class KeyAlertKafkaSink extends RichSinkFunction<Tuple3<String, NameModel, Long>> {
    ...
    public KeyAlertKafkaSink(String bootstrapServers, int port, String dbname, String collection, String userName, String password, SinkType sinkType) {
    ...
    public void open(Configuration parameters) throws Exception {
        ...
        ServerAddress serverAddress = new ServerAddress(bootstrapServers, port);
